...
Since the logistic equation is exponential it is easier to consider working with the formula in terms of the the odds or log odds. Odds are the probabilities of success over failure denoted as $\Large \frac{p}{1-p}$ or log odds as $\large ln \left (\frac{p}{1-p} \right )$.
...
- The number of unique false-positives and false-negatives are 26.
