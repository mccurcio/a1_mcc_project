...
Logistic regression derives its name from its similarity to linear regression, as we shall see below. The output of a Logistic Regression is not represented by the set of real numbers, ($y ~ \notin ~ \Re$), as is found with Linear Regression, instead, Logistic Regression is used for classification between two states. The term logistic should be a reminder that the function's output is a set logical values, 0's and 1's. 
