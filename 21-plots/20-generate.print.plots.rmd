...
png(filename = "../00-data/05-joins_plots/pca_outlier.png")
dev.off()
plot(x = row_pc12[, 2], 
     y = row_pc12[, 3], 
...
### Logit Plot
```{r echo=FALSE, fig.height=7, fig.width=7}
png(filename = "../00-data/05-joins_plots/logit_pca.png")
...
### Random Forest Plot
```{r echo=FALSE, fig.height=7, fig.width=7}
png(filename = "../00-data/05-joins_plots/rf_pca.png")
...
### SVM-Linear Plot
```{r echo=FALSE, fig.height=7, fig.width=7}
png(filename = "../00-data/05-joins_plots/svm_linear_pca.png")
...
### SVM-Polynomial Plot
```{r echo=FALSE, fig.height=7, fig.width=7}
png(filename = "../00-data/05-joins_plots/svm_poly_pca.png")
...
```{r echo=FALSE, fig.height=7, fig.width=7}
png(filename = "../00-data/05-joins_plots/svm_rbf_pca.png")
