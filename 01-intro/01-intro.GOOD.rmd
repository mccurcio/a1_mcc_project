...
At the intersection between Applied Mathematics, Computer Science, and an understanding of Biological Sciences is a subset of knowledge known as Bioinformatics. Some find Bioinformatics and its more general cousin Data Science difficult to define. The most ubiquitous pictograph is indeed the intersection of three fields of study. See Figure \ref{venn_diagram}. More pointedly Data Science is a mixture of biological data analysis, using computers and software and importantly predicitive modeling. For some Bioinformaticians the question becomes can we use readily availabble data and describe it, model it by using mathematics. Other similar fields you may come across would be the study of chemistry with computers and applied mathematics which beget the field of Chemoinformatics.[^11] [^12] Health or Healthcare begets the field Healthcare-Informatics.[^13]
