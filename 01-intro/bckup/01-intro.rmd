...
In binary classification, a two by two contingency table is used to descirbe predicted versus actual value classifications. This is also known as a confusion matrix to machine learning students. 
...
There are many ways to further describe the results using this confusion matrix, however the one measure which will be used here is Accuracy.

$$Accuracy ~=~ \frac{TP + TN}{Total ~ Number}$$

The second goal of this experiment is to produce the False Positives and False-Negtives and evaluating these by comparing them to the Principal Component Analysis Biplot of the first two Principal Components.