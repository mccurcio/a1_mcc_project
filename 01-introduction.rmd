...
```{r 12, fig.height=2,fig.width=4,echo=FALSE,fig.align="center",fig.cap="Venn Diagrams of Bioinformatics And Data Science",cache=TRUE}
...
```{r 13,echo=FALSE,fig.align="center",fig.height=1,fig.cap="K-Nearest-Neighbor",cache=TRUE}
...
In contrast to the supervised learning system, unsupervised learning **does not require or use a label**. 
...
```{r 14,fig.height=2,fig.width=2,echo=FALSE,fig.align="center",fig.cap="K-Means",cache=TRUE}
...
```{r 15,fig.height=2,fig.width=2,echo=FALSE,fig.align="center",fig.cap="Bias-Variance Tradeoff",cache=TRUE}
...
```{r 16,fig.height=2,fig.width=4,echo=FALSE,fig.align="center",fig.cap="Mean Percent Amino Acid Compositions For Control And Myoglobin",cache=TRUE}
