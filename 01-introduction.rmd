...
```{r 13,echo=FALSE,fig.align="center",fig.height=1.8,fig.cap="K-Nearest-Neighbor",cache=TRUE}
...
```{r 14,fig.height=2,echo=FALSE,fig.align="center",fig.cap="K-Means",cache=TRUE}
...
```{r 15,fig.height=2.5,echo=FALSE,fig.align="center",fig.cap="Bias-Variance Tradeoff",cache=TRUE}
...
```{r 16,echo=FALSE,fig.align="center",fig.cap="Mean Percent Amino Acid Compositions For Control And Myoglobin",cache=TRUE}
