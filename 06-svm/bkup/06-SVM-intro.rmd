...
In test #1, the isozymes can easily separated by activity alone. This first figure demonstrates that the data is "linearly separable,"[^63] To re-state the obvious, the two groups are linearly separable if a single straight line can partition the data.
