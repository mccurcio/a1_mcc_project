...
Support vector machine (SVM) learning is a supervised learning technique which may be used as a classification system or to find regression formulae. Support Vector Machines were described by Vladimir Vapnik and Corinna Cortes in 1995 while at Bell Labs.[^61]

[^61]:V. Vapnik and C. Cortes, Machine Learning, 20, 273-297, 1995

SVM is also **Non-parametric** approach to regression and classification. What is Nonparametric? For that matter, what is parametric learning and models. Just as we have learned that machine learning models can be supervised, unsupervised or even semi-supervised another characteristic between machine learning models is whether they are parametric or not. This is a tricky topic.

In the Webster's dictionary[^62] states a *parameter* is

>[The] estimation of the values which enter into the equation representing the chosen relation
>
...
Another definition from a modern machine learning textbook is
...
The definition by Murphy is interesting but not detailed enough.  Let us tease apart this definition by looking into examples. 
