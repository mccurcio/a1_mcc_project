...
read_fasta <- function(file) {
    listo_proteins <- read.fasta(file,
                            seqtype = "AA",
                            as.string = TRUE,
                            seqonly = FALSE,
                            strip.desc = TRUE)
...
file <- "../00-data/01-ORIGINAL_DATA/uniprot-myoglobin.fasta"
...
file <- "../00-data/01-ORIGINAL_DATA/uniprot-human+NOT+hemoglobin+NOT+myoglobin+random.fasta"
...
## Appendix: Machine Setting & Session Info
