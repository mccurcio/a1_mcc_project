...
1. Outlier_1: c_m_20_PCA$x[, 1] > 3 

2. Outlier_2: c_m_20_PCA$x[, 1] < -3
```{r}
...
3. Outlier_3: c_m_20_PCA$x[, 2] > 3  

4. Outlier_4: c_m_20_PCA$x[, 2] < -3  
```{r}
...
### Subset Outliers from PC1 and PC2 data
myvars <- c("v1", "v2", "v3")
...
Therefore the list of 461 outliers will be further broken into a group of control and positive proteins for later work.
