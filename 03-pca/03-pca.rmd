...
- While disadvantages include:
    ...
    3. Intuitive understanding can tricky.
...
Remember this simplified formula is to determine covariance for a 2 dimensional system. Where $N$ is the number of observations, $\bar x$ is the mean of the independent variable, $\bar y$ is the mean of the dependent variable.

### Covariance of matrices {-}

However when dealing with larger number of variables one needds to Determine the covariance of a matrices, $\large M$ using linear algebra notation is;[^34]
