...
while the range for the transformed data is (-2.45 <= x <= 2.76). The differences of the two ranges is 3 and 5.21 units respectively. This should be no surprise since the PCA is essentially a maximization of variance.
...
Although the differences is between all three histograms is minor any transfomation *would* be sufficient to use. However I chose to use the *Normalized* dataset.
