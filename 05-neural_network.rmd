...
```{r 52, fig.width=4, echo=FALSE, fig.align="center", fig.cap='Basic Neuron Types and S.E.M. Image'}
...
```{r 53, fig.width=4, echo=FALSE, fig.align="center", fig.cap="Two Neuron System (Image From The Public Domain)"}
...
```{r 54, fig.width=3, fig.height=1.2 ,fig.cap="Goal of a Tesla Neural Networks is to generate the correct repsonses for its environment.", fig.align="center", echo=FALSE}
...
```{r 55, fig.width=4, fig.cap="One Neuron Schema", fig.asp="125%", fig.align="center", echo=FALSE}
...
```{r 58, fig.width=5, fig.cap="A Two Neuron System", fig.align = "center", echo=FALSE}
...
[^510]:David Rumelhart, Geoffrey Hinton, & Ronald Williams, Learning represetnations by back-propagating Errors, Nature, 323, 533-536, Oct. 9, 1986
...
Using the chain-rule, and figure 6, *Two Neuron System* as a guide, we can backwards to derive the formuls for error back-propagation. We find:
...
TuneSizeDecay <- expand.grid(size = c(10, 12, 14, 16, 18, 20), 
                             decay = c(1, 0.1, 0.01, 0.01))
```
