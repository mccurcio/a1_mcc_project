...
```{r 53,fig.height=2,echo=FALSE,fig.align="center",fig.cap="Two Neuron System (Image From The Public Domain)"}
...
```{r 54,fig.height=2,fig.cap="Goal of a Tesla Neural Networks is to generate the correct responses for its environment.",fig.align="center",echo=FALSE}
...
```{r 55,fig.height=3,fig.cap="One Neuron Schema",fig.align="center",echo=FALSE}
