...
3. SVM-polynomial, 
4. SVM-RBF, 
5. Neural Network with auto-encoding.
...
```{r, 212, echo=FALSE, fig.cap='Column-Means of % Composition Vs Amino Acid', out.width='60%', fig.asp=1, fig.align='center'}
...
### Plot the coefficient of variance (CV), RAW data
