...
1. Can the Random Forest technique known as Boruta[^101], be used for feature importance or reduction? 
...
[^101]:Miron Kursa, Witold Rudnicki, Feature Selection with the Boruta Package, DOI:10.18637/jss.v036.i11
...
- Roger Peng's booklet on 'Exploratory Data Analysis with R,'  

- 'Exploratory Data Analysis Using R', by Ronald K. Pearson.[^102]  
...
we expect? (Indeed, what relationships do we expect, and why?)[^100]

[^100]:Ronald Pearson, 'Exploratory Data Analysis Using R', P.11, CRC Press, 2018

[^102]:Ronald Pearson, 'Exploratory Data Analysis Using R', P.11, CRC Press, 2018
...
c_m_RAW_AAC <- read_csv("/home/mcc/Dropbox/a1_mcc_project/00-data/aac_dpc_values/c_m_RAW_AAC.csv")
